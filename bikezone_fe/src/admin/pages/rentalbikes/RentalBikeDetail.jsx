...
const RentalBikeDetail = () => {
    ...
    const { rentBike, isLoading } = useSelector(state => state.rentBike)
                                ...
                                <div className='border-b py-6 border-black '>
                                    <div className=' flex justify-between items-center'>
                                        ...
                                        <div className='flex flex-col justify-center items-center'>
                                            <img className="m-2 h-12 w-12 rounded-md border border-black object-cover object-center cursor-pointer hover:scale-110 duration-300 hover:shadow-md hover:shadow-yellow-400" src={rentBike?.seller?.imageURL} alt='true' />
                                            <span>Owner</span>
                                        </div>
                                    </div>
...
export default RentalBikeDetail