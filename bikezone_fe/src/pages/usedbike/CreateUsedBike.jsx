...
const CreateUsedBike = () => {
    ...
    const { isLoading } = useSelector((state) => state.usedBike)
                                    ...
                                    <div className="w-full lg:w-6/12 px-4">
                                        <div className="relative w-full mb-3">
                                            ...
                                            <input
                                                ...
                                                onBlur={handleBlur}
                                                type="text"
                                                placeholder='enter bike year' className="border-0 px-3 py-3 border-b border-black  bg-gray-100 rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                    ...
                                    <div className="w-full lg:w-6/12 px-4">
                                        <div className="relative w-full mb-3">
                                            ...
                                            <input
                                                ...
                                                id='mileage'
                                                name='mileage'
                                                placeholder='enter bike mileage e.g. 1000'
