...
const Shipping = () => {
    ...
    return (
        <>
            ...
            <CheckoutSteps activeStep={0} color={"bg-[#d0d1d1]"}/>

            <div className="min-w-screen bg-[#d0d1d1] min-h-screen flex items-center justify-center px-5 py-5">
                                    ...
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input
                                                ...
                                                onBlur={handleBlur}
                                                className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-100 outline-none focus:border-indigo-500" placeholder="xxxx xxxxxxx" />
                                        </div>
                                    ...
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                onBlur={handleBlur}
                                                className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-100  outline-none focus:border-indigo-500" placeholder="city name" />
                                        </div>
                                    ...
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                onBlur={handleBlur}
                                                className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-100  outline-none focus:border-indigo-500" placeholder="state name" />
                                        </div>
                                    ...
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                onBlur={handleBlur}
                                                className="w-full -ml-10 pl-10 pr-3 py-2 bg-gray-100 rounded-lg  outline-none focus:border-indigo-500" placeholder="- - - -" />
                                        </div>
