                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div class="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            <div class="mb-8 flex w-full max-w-[370px]">
                                <div
                                    class="bg-[#122222] bg-opacity-2 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded  sm:h-[70px] sm:max-w-[70px]"
                                >
                                    <svg
                                        width="24"
                                        height="24"
                        ...
                        <div class="relative rounded-lg  bg-[#def5f5] p-8 shadow-xl sm:p-12">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        class="bg-primary border-primary w-full rounded border p-3 text-white bg-[#122222] transition hover:bg-opacity-90"
                                    >
                                        Send Message
                                    </button>
                                </div>
