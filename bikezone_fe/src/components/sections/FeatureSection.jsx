                ...
                <div className="absolute inset-0  z-30  flex flex-col items-center justify-center">
                    <div className="shadow-2xl rounded-lg w-4/5 h-96 bg-cover bg-center" style={{ backgroundImage: 'url("https://wallpapercave.com/wp/wp6689710.jpg")' }}>
                        <div className="grid grid-cols-12 ">
                            <div className="relative my-6 px-8 col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xxl:col-span-6">
                            ...
                            <div className="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xxl:col-span-6">
                                <div className=" md:relative bg-pink-900 h-full md:h-96 w-full bg-opacity-50 rounded-tr-lg rounded-br-lg">
                                    <div className="">
                                        <p className="text-yellow-300 text-xs md:text-sm  tracking-widest p-4 mb-4 ">
                                        ...
                                        <div className="bottom-0 md:absolute absolute p-2 right-0 ">
