...
const ReviewCard = ({ review }) => {
    ...
    return (
        ...
        <div className="px-5 py-4 bg-white dark:bg-gray-800 shadow rounded-lg w-[400px]">
            <div className="flex mb-4">
                ...
                <div className="ml-2 mt-0.5">
                    <span className="block font-medium text-base leading-snug text-black dark:text-gray-100">{review.name}</span>
                    <ReactStars  {...options} />
